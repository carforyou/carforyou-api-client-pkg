...
const defaults: ListingType = {
  ...
  price: 1234532,
  listPrice: 123456,
  firstStablePrice: 12345,
  priceReductionPercentage: 10,
  hasReducedPrice: true,
  leasingMonthlyRate: 299,
  loanMonthlyRateFrom: 300,
  loanMonthlyRateTo: 500,
  ...
  tuned: false,
  racingCar: false,
  lastServiceDate: { month: 2, year: 2020 },
  hasFullServiceHistory: false,
  minOneYearFreeServiceIncluded: true,
  priceNegotiable: false,
  firstOwner: true,
  hasRefundPolicy: false,
  breakdownServiceIncluded: true,
  damaged: false,
  enabledFeatures: [
    {
...
export function EmptyListing(): ListingType {
  return {
    ...
    inspected: undefined,
    inspectedEffective: undefined,
    price: undefined,
    listPrice: undefined,
    firstStablePrice: undefined,
    priceReductionPercentage: undefined,
    hasReducedPrice: undefined,
    leasingMonthlyRate: undefined,
    loanMonthlyRateFrom: undefined,
    loanMonthlyRateTo: undefined,
    tsn: undefined,
    ...
    hasFullServiceHistory: undefined,
    minOneYearFreeServiceIncluded: undefined,
    priceNegotiable: undefined,
    firstOwner: undefined,
    hasRefundPolicy: undefined,
    breakdownServiceIncluded: undefined,
    damaged: undefined,
    standard: [],
    optional: [],
    ...
    range: undefined,
    rangeExtraUrban: undefined,
    rangeUrban: undefined,
    chargePort: undefined,
    chargePower: undefined,
    chargeSpeed: undefined,
    fastChargePort: undefined,
    fastChargePower: undefined,
    fastChargeSpeed: undefined,
    source: undefined,
...
export function ListingFromType({
  ...
  return {
    ...
    rangeExtraUrban: rangeExtraUrban || undefined,
    rangeUrban: rangeUrban || undefined,
    chargePort: chargePort || undefined,
    chargePower: chargePower || undefined,
    chargeSpeed: chargeSpeed || undefined,
    fastChargePort: fastChargePort || undefined,
    fastChargePower: fastChargePower || undefined,
    fastChargeSpeed: fastChargeSpeed || undefined,
    transmissionType,
